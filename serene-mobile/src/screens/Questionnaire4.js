...
const Questionnaire4 = ({ navigation, route }) => {
  const { q1, q2, q3 } = route.params;
  const [selectedAnswer, setSelectedAnswer] = useState(null);

  const handleNext = () => {
    if (selectedAnswer !== null) {
      // Passing all 4 scores to Q5
      navigation.navigate("Questionnaire5", { q1, q2, q3, q4: selectedAnswer });
    } else {
    ...
    <LinearGradient colors={["#D7D9F4", "#E8E3F9", "#F4F3FF"]} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.questionCard}>
          <Text style={styles.questionText}>Q4. I felt capable of handling the challenges that came my way.</Text>
