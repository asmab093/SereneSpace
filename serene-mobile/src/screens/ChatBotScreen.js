...
//   // 🛠️ Auto-scroll on mount and message updates
//   useEffect(() => {
//     if (messages.length > 0) {
//       const timeoutId = setTimeout(() => {
//         scrollViewRef.current?.scrollToEnd({ animated: true });
...
//   headerTitle: { fontSize: 20, fontWeight: "bold", color: "#512DA8" },
//   messageContainer: {
//     flexDirection: "row",
//     marginVertical: 8,
...
//   userMessageContainer: { justifyContent: "flex-end", flexDirection: "row" },
//   botAvatar: { width: 36, height: 36, marginRight: 8, borderRadius: 18 },
//   messageBubble: {
//     maxWidth: "75%",
//     padding: 12,
//     borderRadius: 16,
...
//     borderColor: "#E0E0E0",
//   },
//   userBubble: { backgroundColor: "#7A64E8" },
//   botText: { color: "#000000" },
//   userText: { color: "#FFFFFF" },
//   scrollContentContainer: { paddingVertical: 16, paddingHorizontal: 8 },
//   loadingText: { textAlign: "center", marginVertical: 12, color: "#666" },
//   inputBar: {
//     flexDirection: "row",
//     paddingHorizontal: 12,
//     paddingVertical: 8,
...
//   micButton: { padding: 8 },
//   micIcon: { width: 28, height: 28, tintColor: "#512DA8" },
//   textInputContainer: { flex: 1, marginHorizontal: 8 },
//   textInput: {
...
//     marginRight: 8,
//   },
//   recordingText: { color: "red", fontWeight: "bold" },
//   alertBanner: {
//     flexDirection: "row",
//     alignItems: "center",
