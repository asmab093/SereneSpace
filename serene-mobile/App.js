...
// import { createStackNavigator } from "@react-navigation/stack";import { AuthProvider } from "./src/context/AuthContext";
...
//   require("./src/assets/Doctor1.png"),
//   require("./src/assets/Doctor2.png"),
...
//   require("./src/assets/WhatsappIcon.png"),
...
// // 💡 NEW: This component wraps the Home screen inside the Drawer
// const DrawerNavigator = () => {
//   return (
//     <Drawer.Navigator
//       drawerContent={(props) => <CustomDrawer {...props} />} // Uses your CustomDrawer component
//       screenOptions={{
//         headerShown: false,
...
//             screenOptions={{
//               headerShown: false,
//               // This adds the "Slide" animation automatically
...
//             {/* ✅ FIXED: Point Home directly to HomeScreen */}
...
//             {/* Accounts related */}
//             <Stack.Screen name="Accounts" component={AccountSecurityScreen} />
//             <Stack.Screen
